...
/**
 * Created by wurongqiu on 2018/6/28.
 */
...
public class IpUtil {
    ...
    public static InetAddress getAddressName(String address) {
        try {
            InetAddress inetAddress[] = InetAddress.getAllByName(address);
//            Toast.makeText(MainActivity.this, "Address is " + inetAddress.getHostAddress(), Toast.LENGTH_LONG).show();      }
